# Generated by Django 3.2.20 on 2023-08-08 19:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Введите логин для регистрации, не более 150 символовиспользуя только буквы, цифры и @/./+/-/_ .', max_length=150, unique=True, validators=[users.validators.validate_username], verbose_name='Логин пользователя')),
                ...
                ('email', models.EmailField(db_index=True, help_text='Введите адрес электронной почты для регистрации.', max_length=254, unique=True, verbose_name='Адрес электронной почты')),
